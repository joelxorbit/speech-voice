...
if(isset($btn))
{
	...
	{
mysqli_query($connect,"update pet_apply set status=2,process='$process' where id=$id");
	}
	else
	{
mysqli_query($connect,"update pet_apply set status=1,process='$process' where id=$id");	
	}
$mobile=$row['contact'];
$message="Dear $name, Your Petition Process has $process";
...
window.location.href="off_home.php";
</script>
<?php
}
?>
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
  ...
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="25" class="subhead"><?php include("include/link_off.php"); ?></td>
    </tr>
    <tr>
      <td height="407" align="center" valign="top"><p>&nbsp;</p>
        <p>&nbsp;</p>
        <p class="txt3">Applied Details </p>
        <p>&nbsp;</p>
