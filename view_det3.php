...
if(isset($btn))
{
mysqli_query($connect,"update pet_apply set status=1 where id=$id");

$mobile=$row['contact'];

$message="Dear $name, Your Petition Process has Started";
...
alert("Petition Process has Completed");
  ...
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="407" align="center" valign="top"><p>&nbsp;</p>
        ...
        <p>&nbsp; </p>
      <p align="center">
        <input type="submit" name="btn" value="Start Process">
      </p>        
      <p>&nbsp;</p></td>
    </tr>
    <tr>
