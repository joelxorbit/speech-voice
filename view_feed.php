  ...
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td align="center" valign="top"><p>&nbsp;</p>
        ...
        <p align="center">&nbsp;</p>
        <?php
		$q1=mysqli_query($connect,"select * from pet_feedback order by id desc");
        ...
        <table width="768" border="1">
          <tr>
            <th width="83" scope="col">Sno</th>
            <th width="285" scope="col">User</th>
            <th width="290" scope="col">Comments</th>
            <th width="252" scope="col">Date</th>
          </tr>
          <?php
		  $i=0;
